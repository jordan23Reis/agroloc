...
export class FavoritoController {
  ...
  @UseGuards(
    ...
    UsuarioCorretoGuard,
    UsuarioExisteGuard,
    FavoritarFreteiroGuard
  )
  @Post('freteiro/:id/:idFreteiro')
  createFavoritoFreteiro(
    @Param('id') idUsuarioFavoritador: string,
    @Param('idFreteiro') idFreteiro: string
  ) {
    return this.favoritoService.adicionarFreteiroFavorito(
      idUsuarioFavoritador,
      idFreteiro
    );
  }
  ...
  @UseGuards(
    ...
    UsuarioCorretoGuard,
    UsuarioExisteGuard,
    DesfavoritarFreteiroGuard
  )
  @Delete('freteiro/:id/:idFavorito')
  deleteFavoritoFreteiro(
    @Param('id') idUsuarioDesfavoritador: string,
    @Param('idFavorito') idFavorito: string
  ) {
    return this.favoritoService.removerFreteiroFavorito(
      idUsuarioDesfavoritador,
      idFavorito
    );
  }
  ...
  @UseGuards(
    ...
    UsuarioCorretoGuard,
    UsuarioExisteGuard,
    FavoritarMaquinaGuard
  )
  @Post('maquina/:id/:idMaquina')
  createFavoritoMaquina(
    @Param('id') idUsuarioFavoritador: string,
    @Param('idMaquina') idMaquina: string
  ) {
    return this.favoritoService.adicionarMaquinaFavorita(
      idUsuarioFavoritador,
      idMaquina
    );
  }
  ...
  @UseGuards(
    ...
    UsuarioCorretoGuard,
    UsuarioExisteGuard,
    DesfavoritarMaquinaGuard
  )
  @Delete('maquina/:id/:idFavorito')
  deleteFavoritoMaquina(
    @Param('id') idUsuarioDesfavoritador: string,
    @Param('idFavorito') idFavorito: string
  ) {
    return this.favoritoService.removerMaquinaFavorita(
      idUsuarioDesfavoritador,
      idFavorito
    );
  }
